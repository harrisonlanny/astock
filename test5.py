...
#     fields=["file_title"],
#     result_type="dict",
#     filter_str="where title not like '%英文%' and title not like '%取消%' and title not like '%摘要%' and title not like '%公告%' and title like '%2022%' ORDER BY RAND() LIMIT 100",
# )
...
# filter_by_standard_unqualified_opinions(file_title_list)